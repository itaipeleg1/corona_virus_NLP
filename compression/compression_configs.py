...
compression_configs = {
    ...
    "covidbert_pytorch": {
        ...
        "knowledge_distillation_path": COMPRESSION_OUTPUT_DIR / 'covidbert_pytorch' / 'covidbert_pytorch_knowledge_distillation_state_dict.pt'

    },
    "bertweet_HF": {
        "base_path": PROJECT_ROOT / "results/best_models/bertweet_HF_study_augmented_state_dict.pt",
        "knowledge_distillation_path": COMPRESSION_OUTPUT_DIR / 'bertweet_HF' / 'bertweet_HF_knowledge_distillation_state_dict.pt'

    },
    "bertweet_pytorch": {
        "base_path": PROJECT_ROOT / "results/best_models/bertweet_pytorch_study_augmented_state_dict.pt",
        "knowledge_distillation_path": COMPRESSION_OUTPUT_DIR / 'bertweet_pytorch' / 'bertweet_pytorch_knowledge_distillation_state_dict.pt'
    }
}